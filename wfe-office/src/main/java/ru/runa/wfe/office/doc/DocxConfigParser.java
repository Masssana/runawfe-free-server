...
public class DocxConfigParser extends FilesSupplierConfigParser<DocxConfig> {
    ...
    protected void parseCustom(Element root, DocxConfig config) throws Exception {
        ...
        for (Element tableElement : tableElements) {
            ...
            tableConfig.setListVariableName(tableElement.attributeValue("listVariable"));
            ...
            for (Element columnElement : columnElements) {
                String attributeName = columnElement.attributeValue("attribute");
                Preconditions.checkNotNull(attributeName, "Missed 'attribute' in column element");
                tableConfig.getColumns().add(attributeName);
            }
        ...
        for (Element hintElement : hintElements) {
            ...
            Preconditions.checkNotNull(variableName, "Missed 'name' attribute in hint");

            String formatClassName = hintElement.attributeValue("type");
            Preconditions.checkNotNull(formatClassName, "Missed 'type' attribute in hint");
